...
<div class:vertical={!expanded} class="horizontal container yaml-option-level-two">
			...
			{#each itemPlando as itemPlandoItemGroup, itemPlandoIndex}
				...
				<div class="container horizontal yaml-option-level-three">
					...
					<div class="vertical container" class:hidden={!itemPlandoItemGroup.expanded}>
						<!-- <div class="vl" /> -->
						<div class="container flexgrow" class:horizontal={itemPlandoItemGroup.expanded}>
							<div class="container">
							...
							<!-- <div class="container"> -->
								<p class:hidden={!expanded} class="minimized-data dropdown border-below">
									<b>Items: </b>
							...
							<table>
								...
								<tr>
									<td>world</td>
									<td>
										<select bind:value={itemPlandoItemGroup.world}>
											...
											<option value={ItemPlandoWorld.PlayerNames}
												>comma-separated list of names</option
											>
								...
								<tr>
									<td>count</td>
									<td>
										<select bind:value={itemPlandoItemGroup.count}>
	...
	<ul class:hidden={expanded} class="minimized-data dropdown">
		{#each itemPlando as itemPlandoItemGroup}<li>
				...
				>
				of the below-listed items will have a <b>{itemPlandoItemGroup.percentage}%</b> chance to
				appear in the below-listed locations in
				<b
