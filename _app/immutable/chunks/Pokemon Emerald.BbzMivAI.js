const e={name:"Player{number}",description:"Default Pokemon Emerald Template",game:"Pokemon Emerald",requires:{version:"0.4.6"},"Pokemon Emerald":{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
...
"Lugia"
"Deoxys"
"Mew"`,allowed_legendary_hunt_encounters:["Mew","Registeel","Latias","Groudon","Latios","Regice","Kyogre","Lugia","Deoxys","Ho-Oh","Rayquaza","Regirock"],"sidneys_secret_documentation-wild_pokemon":`Randomizes wild pokemon encounters (grass, caves, water, fishing)
...
Use "_Legendaries" as a shortcut for legendary pokemon.`,wild_encounter_blacklist:[],"sidneys_secret_documentation-starters":`Randomizes the starter pokemon in Professor Birch's bag
...
Use "_Legendaries" as a shortcut for legendary pokemon.`,starter_blacklist:[],"sidneys_secret_documentation-trainer_parties":`Randomizes the parties of all trainers.
...
when evolving, the random ability will also be retained`,abilities:{vanilla:50,completely_random:0,follow_evolutions:0},"sidneys_secret_documentation-ability_blacklist":`A list of abilities which no pokemon should have if abilities are randomized.
For example, you could exclude Wonder Guard and Arena Trap like this:
["Wonder Guard", "Arena Trap"]`,ability_blacklist:[],"sidneys_secret_documentation-level_up_moves":`Randomizes the moves a pokemon learns when they reach a level where they would learn a move.
...
If a move is not forced to be Normal, it will be completely random.`,move_normal_type_bias:{0:50,sidneys_secret_range_start:0,sidneys_secret_range_end:100,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-tm_tutor_compatibility":"Sets the percent chance that a given TM or move tutor is compatible with a species",tm_tutor_compatibility:{sidneys_secret_range_start:0,sidneys_secret_range_end:100,random:0,"random-low":0,"random-high":0,"sidneys_secret_notes-vanilla":"equivalent to -1",vanilla:50},"sidneys_secret_documentation-hm_compatibility":"Sets the percent chance that a given HM is compatible with a species",hm_compatibility:{sidneys_secret_range_start:50,sidneys_secret_range_end:100,random:0,"random-low":0,"random-high":0,"sidneys_secret_notes-vanilla":"equivalent to -1",vanilla:50},"sidneys_secret_documentation-tm_tutor_moves":"Randomizes the moves taught by TMs and move tutors",tm_tutor_moves:{false:50,true:0},"sidneys_secret_documentation-reusable_tms_tutors":"Sets TMs to not break after use (they remain sellable). Sets move tutors to infinite use.",reusable_tms_tutors:{false:50,true:0},"sidneys_secret_documentation-move_blacklist":"A list of moves which should be excluded from learnsets, TMs, and move tutors.",move_blacklist:[],"sidneys_secret_documentation-min_catch_rate":`Sets the minimum catch rate a pokemon can have. Any pokemon with a catch rate below this floor will have it raised to this value.
...
"Aqua Hideout Grunts"
"Seafloor Cavern Aqua Grunt"`,remove_roadblocks:[],"sidneys_secret_documentation-extra_boulders":`Places strength boulders on Route 115 which block access to Meteor Falls from the beach.
...
All secret phrases are something that could be a trendy phrase in Dewford Town. They are case insensitive.`,easter_egg:{"EMERALD SECRET":50}}};export{e as default};
