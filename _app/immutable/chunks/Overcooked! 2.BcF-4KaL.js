const e={name:"Player{number}",description:"Default Overcooked! 2 Template",game:"Overcooked! 2",requires:{version:"0.4.6"},"Overcooked! 2":{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
...
record score and 45% is the average vanilla 4-star score.`,star_threshold_scale:{35:50,sidneys_secret_range_start:1,sidneys_secret_range_end:100,random:0,"random-low":0,"random-high":0}}};export{e as default};
