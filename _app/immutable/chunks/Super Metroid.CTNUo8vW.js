const e={name:"Player{number}",description:"Default Super Metroid Template",game:"Super Metroid",requires:{version:"0.4.6"},"Super Metroid":{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
...
The Crystal Flash ends when Samus is out of ammo or a total of 30 ammo has been consumed.`,relaxed_round_robin_cf:{false:50,true:0}}};export{e as default};
