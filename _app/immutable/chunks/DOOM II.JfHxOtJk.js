const e={name:"Player{number}",description:"Default DOOM II Template",game:"DOOM II",requires:{version:"0.5.0"},"DOOM II":{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
...
- **Minimal:** ensure what is needed to reach your goal can be acquired.`,accessibility:{locations:0,items:50,minimal:0},"sidneys_secret_documentation-difficulty":`Choose the difficulty option. Those match DOOM's difficulty options.
