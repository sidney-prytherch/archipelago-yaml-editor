const e={name:"Player{number}",description:"Default Subnautica Template",game:"Subnautica",requires:{version:"0.4.6"},Subnautica:{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
...
Note: can be toggled via in-game console command "deathlink".`,death_link:{false:50,true:0},"sidneys_secret_documentation-start_inventory_from_pool":`Start with these items and don't place them in the world.
The game decides what the replacement items will be.`,start_inventory_from_pool:{},"sidneys_secret_documentation-filler_items_distribution":`Random chance weights of various filler resources that can be obtained.
