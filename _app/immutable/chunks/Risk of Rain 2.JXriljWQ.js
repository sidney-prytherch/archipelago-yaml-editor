const e={name:"Player{number}",description:"Default Risk of Rain 2 Template",game:"Risk of Rain 2",requires:{version:"0.4.6"},"Risk of Rain 2":{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
...
Any: Any victory in the game will count. See Final Stage Death for additional ways.`,victory:{any:50,mithrix:0,voidling:0,limbo:0},"sidneys_secret_documentation-total_locations":"Classic Mode: Number of location checks which are added to the Risk of Rain playthrough.",total_locations:{40:50,sidneys_secret_range_start:40,sidneys_secret_range_end:250,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-chests_per_stage":"Explore Mode: The number of chest locations per environment.",chests_per_stage:{10:50,sidneys_secret_range_start:2,sidneys_secret_range_end:20,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-shrines_per_stage":"Explore Mode: The number of shrine locations per environment.",shrines_per_stage:{5:50,sidneys_secret_range_start:2,sidneys_secret_range_end:20,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-scavengers_per_stage":"Explore Mode: The number of scavenger locations per environment.",scavengers_per_stage:{0:50,sidneys_secret_range_start:0,sidneys_secret_range_end:1,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-scanner_per_stage":"Explore Mode: The number of scanners locations per environment.",scanner_per_stage:{1:50,sidneys_secret_range_start:0,sidneys_secret_range_end:1,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-altars_per_stage":"Explore Mode: The number of altars locations per environment.",altars_per_stage:{1:50,sidneys_secret_range_start:0,sidneys_secret_range_end:2,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-total_revivals":"Total Percentage of `Dio's Best Friend` item put in the item pool.",total_revivals:{4:50,sidneys_secret_range_start:0,sidneys_secret_range_end:10,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-start_with_revive":"Start the game with a `Dio's Best Friend` item.",start_with_revive:{false:0,true:50},"sidneys_secret_documentation-final_stage_death":`The following will count as a win if set to "true", and victory is set to "any":
...
Victory: limbo - Obliterating yourself will count.`,final_stage_death:{false:50,true:0},"sidneys_secret_documentation-dlc_sotv":`Enable if you are using SOTV DLC.
 ...
 Adds Void Items into the item pool`,dlc_sotv:{false:50,true:0},"sidneys_secret_documentation-require_stages":"Add Stage items to the pool to block access to the next set of environments.",require_stages:{false:0,true:50},"sidneys_secret_documentation-progressive_stages":`This will convert Stage items to be a progressive item. For example instead of "Stage 2" it would be
 "Progressive Stage"`,progressive_stages:{false:0,true:50},"sidneys_secret_documentation-death_link":"When you die, everyone dies. Of course the reverse is true too.",death_link:{false:50,true:0},"sidneys_secret_documentation-item_pickup_step":`Number of items to pick up before an AP Check is completed.
...
- Void makes everything a void item.`,item_weights:{default:50,new:0,uncommon:0,legendary:0,chaos:0,no_scraps:0,even:0,scraps_only:0,lunartic:0,void:0},"sidneys_secret_documentation-item_pool_presets":"Will use the item weight presets when set to true, otherwise will use the custom set item pool weights.",item_pool_presets:{false:50,true:0},"sidneys_secret_documentation-green_scrap":`Weight of Green Scraps in the item pool.

(Ignored unless Item Weight Presets is 'No')`,green_scrap:{16:50,sidneys_secret_range_start:0,sidneys_secret_range_end:100,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-red_scrap":`Weight of Red Scraps in the item pool.

(Ignored unless Item Weight Presets is 'No')`,red_scrap:{4:50,sidneys_secret_range_start:0,sidneys_secret_range_end:100,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-yellow_scrap":`Weight of yellow scraps in the item pool.

(Ignored unless Item Weight Presets is 'No')`,yellow_scrap:{1:50,sidneys_secret_range_start:0,sidneys_secret_range_end:100,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-white_scrap":`Weight of white scraps in the item pool.

(Ignored unless Item Weight Presets is 'No')`,white_scrap:{32:50,sidneys_secret_range_start:0,sidneys_secret_range_end:100,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-common_item":`Weight of common items in the item pool.
...
(Ignored unless Item Weight Presets is 'No')`,teleport_trap:{20:50,sidneys_secret_range_start:0,sidneys_secret_range_end:100,random:0,"random-low":0,"random-high":0}}};export{e as default};
