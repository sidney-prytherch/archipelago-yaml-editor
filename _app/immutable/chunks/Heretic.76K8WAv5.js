const e={name:"Player{number}",description:"Default Heretic Template",game:"Heretic",requires:{version:"0.5.0"},Heretic:{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
