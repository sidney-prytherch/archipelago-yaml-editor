const e={name:"Player{number}",description:"Default DOOM 1993 Template",game:"DOOM 1993",requires:{version:"0.4.6"},"DOOM 1993":{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
...
If none of the episodes are chosen, Episode 1 will be chosen by default.`,episode4:{false:50,true:0}}};export{e as default};
