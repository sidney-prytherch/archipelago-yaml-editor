const e={name:"Player{number}",description:"Default Lufia II Ancient Cave Template",game:"Lufia II Ancient Cave",requires:{version:"0.5.0"},"Lufia II Ancient Cave":{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
...
- **Minimal:** ensure what is needed to reach your goal can be acquired.`,accessibility:{locations:0,items:50,minimal:0},"sidneys_secret_documentation-blue_chest_chance":`The chance of a chest being a blue chest.
...
Default value: 25 (five times as much as in an unmodified game)`,blue_chest_chance:{25:50,sidneys_secret_range_start:5,sidneys_secret_range_end:75,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-blue_chest_count":`The number of blue chest items that will be in your item pool.
...
Default value: 25`,blue_chest_count:{25:50,sidneys_secret_range_start:10,sidneys_secret_range_end:100,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-boss":`Which boss to fight on the final floor.
...
Default value: master (same as in an unmodified game)`,boss:{lizard_man:0,big_catfish:0,regal_goblin:0,follower_x2:0,camu:0,tarantula:0,pierre:0,daniele:0,gades_a:0,mummy_x4:0,troll_x3:0,gades_b:0,idura_a:0,lion_x2:0,idura_b:0,idura_c:0,rogue_flower:0,soldier_x4:0,gargoyle_x4:0,venge_ghost:0,white_dragon_x3:0,fire_dragon:0,ghost_ship:0,tank:0,gades_c:0,amon:0,erim:0,daos:0,egg_dragon:0,master:50,"random-low":0,"random-sinistral":0,"random-high":0,"random-middle":0},"sidneys_secret_documentation-capsule_cravings_jp_style":`Make capsule monster cravings behave as in the Japanese version.
...
Default value: false (same as in an unmodified game)`,capsule_cravings_jp_style:{false:50,true:0},"sidneys_secret_documentation-capsule_starting_form":`The starting form of your capsule monsters.

Supported values: 1 – 4, m
Default value: 1 (same as in an unmodified game)`,capsule_starting_form:{sidneys_secret_range_start:1,sidneys_secret_range_end:5,random:0,"random-low":0,"random-high":0,"sidneys_secret_notes-default":"equivalent to 1",default:50,"sidneys_secret_notes-m":"equivalent to 5",m:0},"sidneys_secret_documentation-capsule_starting_level":`The starting level of your capsule monsters.
...
Default value: 1 (same as in an unmodified game)`,capsule_starting_level:{sidneys_secret_range_start:1,sidneys_secret_range_end:99,random:0,"random-low":0,"random-high":0,"sidneys_secret_notes-default":"equivalent to 1",default:50,"sidneys_secret_notes-party_starting_level":"equivalent to 0",party_starting_level:0},"sidneys_secret_documentation-crowded_floor_chance":`The chance of a floor being a crowded floor.
...
Default value: 16 (same as in an unmodified game)`,crowded_floor_chance:{16:50,sidneys_secret_range_start:0,sidneys_secret_range_end:255,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-custom_item_pool":`Customize your multiworld item pool.
...
non-customized space in the pool will be occupied by random blue chest items.`,custom_item_pool:{},"sidneys_secret_documentation-death_link":"When you die, everyone dies. Of course the reverse is true too.",death_link:{false:50,true:0},"sidneys_secret_documentation-default_capsule":`Preselect the active capsule monster.

(Only has an effect if shuffle_capsule_monsters is set to false.)
Supported values: jelze, flash, gusto, zeppy, darbi, sully, blaze
Default value: jelze`,default_capsule:{jelze:50,flash:0,gusto:0,zeppy:0,darbi:0,sully:0,blaze:0},"sidneys_secret_documentation-default_party":`Preselect the party lineup.
...
Default value: M`,default_party:{"random-2p":0,"random-3p":0,"random-4p":0,m:50,ma:0,md:0,mg:0,ml:0,ms:0,mt:0,mad:0,mag:0,mal:0,mas:0,mat:0,mdg:0,mdl:0,mds:0,mdt:0,mgl:0,mgs:0,mgt:0,mls:0,mlt:0,mst:0,madg:0,madl:0,mads:0,madt:0,magl:0,mags:0,magt:0,mals:0,malt:0,mast:0,mdgl:0,mdgs:0,mdgt:0,mdls:0,mdlt:0,mdst:0,mgls:0,mglt:0,mgst:0,mlst:0},"sidneys_secret_documentation-enemy_floor_numbers":`Change which enemy types are encountered at which floor numbers.
...
Default value: vanilla (same as in an unmodified game)`,enemy_floor_numbers:{vanilla:50,shuffle:0,randomize:0},"sidneys_secret_documentation-enemy_movement_patterns":`Change the movement patterns of enemies.
...
Default value: vanilla (same as in an unmodified game)`,enemy_movement_patterns:{vanilla:50,shuffle_by_pattern:0,randomize_by_pattern:0,shuffle_by_sprite:0,randomize_by_sprite:0,singularity:0},"sidneys_secret_documentation-enemy_sprites":`Change the appearance of enemies.
...
Default value: vanilla (same as in an unmodified game)`,enemy_sprites:{vanilla:50,shuffle:0,randomize:0,singularity:0},"sidneys_secret_documentation-exp_modifier":`Percentage modifier for EXP gained from enemies.

Supported values: 100 – 500
Default value: 100 (same as in an unmodified game)`,exp_modifier:{100:50,sidneys_secret_range_start:100,sidneys_secret_range_end:500,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-final_floor":`The final floor, where the boss resides.

Supported values: 2 – 99
Default value: 99 (same as in an unmodified game)`,final_floor:{99:50,sidneys_secret_range_start:2,sidneys_secret_range_end:99,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-gear_variety_after_b9":`Fixes a bug that prevents various gear from appearing after B9.
...
Supported values: false, true
Default value: false (same as in an unmodified game)`,gear_variety_after_b9:{false:50,true:0},"sidneys_secret_documentation-goal":`The objective you have to fulfill in order to complete the game.
...
Default value: boss`,goal:{boss:50,iris_treasure_hunt:0,boss_iris_treasure_hunt:0,final_floor:0},"sidneys_secret_documentation-gold_modifier":`Percentage modifier for gold gained from enemies.

Supported values: 25 – 400
Default value: 100 (same as in an unmodified game)`,gold_modifier:{100:50,sidneys_secret_range_start:25,sidneys_secret_range_end:400,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-healing_floor_chance":`The chance of a floor having a healing tile hidden under a bush.

It is given in units of 1/256, i.e., a value of 16 corresponds to 16/256 = 6.25%.
Supported values: 0 – 255
Default value: 16 (same as in an unmodified game)`,healing_floor_chance:{16:50,sidneys_secret_range_start:0,sidneys_secret_range_end:255,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-inactive_exp_gain":`The rate at which characters not currently in the active party gain EXP.

Supported values: disabled, half, full
Default value: disabled (same as in an unmodified game)`,inactive_exp_gain:{disabled:50,half:0,full:0},"sidneys_secret_documentation-initial_floor":`The initial floor, where you begin your journey.
...
Default value: 1 (same as in an unmodified game)`,initial_floor:{1:50,sidneys_secret_range_start:1,sidneys_secret_range_end:98,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-iris_floor_chance":`The chance of a floor being able to generate an Iris treasure.
...
Default value: 5 (same as in an unmodified game)`,iris_floor_chance:{5:50,sidneys_secret_range_start:5,sidneys_secret_range_end:255,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-iris_treasures_required":`The number of Iris treasures required to complete the goal.

This setting only has an effect if the "iris_treasure_hunt" or "boss_iris_treasure_hunt" goal is active.
Supported values: 1 – 9
Default value: 9`,iris_treasures_required:{9:50,sidneys_secret_range_start:1,sidneys_secret_range_end:9,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-master_hp":`The number of hit points of the Master

(Only has an effect if boss is set to master.)
Supported values: 1 – 9980
Default value: 9980 (same as in an unmodified game)`,master_hp:{9980:50,sidneys_secret_range_start:1,sidneys_secret_range_end:9980,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-party_starting_level":`The starting level of your party members.

Supported values: 1 – 99
Default value: 1 (same as in an unmodified game)`,party_starting_level:{1:50,sidneys_secret_range_start:1,sidneys_secret_range_end:99,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-run_speed":`Modifies the game to allow you to move faster than normal when pressing the Y button.

Supported values: disabled, double, triple, quadruple
Default value: disabled (same as in an unmodified game)`,run_speed:{disabled:50,double:0,triple:0,quadruple:0},"sidneys_secret_documentation-shop_interval":`Place shops after a certain number of floors.
...
Default value: disabled (same as in an unmodified game)`,shop_interval:{sidneys_secret_range_start:1,sidneys_secret_range_end:10,random:0,"random-low":0,"random-high":0,"sidneys_secret_notes-disabled":"equivalent to 0",disabled:50},"sidneys_secret_documentation-shop_inventory":`Determine the item types that can appear in shops.
...
Default value: {spell: 30, gear: 45, weapon: 82}`,shop_inventory:{gear:45,spell:30,weapon:82},"sidneys_secret_documentation-shuffle_capsule_monsters":`Shuffle the capsule monsters into the multiworld.
...
Default value: false (same as in an unmodified game)`,shuffle_capsule_monsters:{false:50,true:0},"sidneys_secret_documentation-shuffle_party_members":`Shuffle the party members into the multiworld.
