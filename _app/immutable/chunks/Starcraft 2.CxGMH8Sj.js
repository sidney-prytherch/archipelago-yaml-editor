const e={name:"Player{number}",description:"Default Starcraft 2 Template",game:"Starcraft 2",requires:{version:"0.4.6"},"Starcraft 2":{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
...
Note: Individual locations subject to plando are always enabled, so the plando can be placed properly.
See also: Excluded Locations, Item Plando (https://archipelago.gg/tutorial/Archipelago/plando/en#item-plando)`,mastery_locations:{enabled:50,resources:0,disabled:0},"sidneys_secret_documentation-minerals_per_item":"Configures how many minerals are given per resource item.",minerals_per_item:{25:50,sidneys_secret_range_start:0,sidneys_secret_range_end:500,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-vespene_per_item":"Configures how much vespene gas is given per resource item.",vespene_per_item:{25:50,sidneys_secret_range_start:0,sidneys_secret_range_end:500,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-starting_supply_per_item":"Configures how much starting supply per is given per item.",starting_supply_per_item:{5:50,sidneys_secret_range_start:0,sidneys_secret_range_end:200,random:0,"random-low":0,"random-high":0}}};export{e as default};
