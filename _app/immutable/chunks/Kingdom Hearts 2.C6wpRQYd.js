const e={name:"Player{number}",description:"Default Kingdom Hearts 2 Template",game:"Kingdom Hearts 2",requires:{version:"0.4.6"},"Kingdom Hearts 2":{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
