const e={name:"Player{number}",description:"Default Adventure Template",game:"Adventure",requires:{version:"0.4.6"},Adventure:{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
...
from each other.`,start_castle:{yellow:50,black:0,white:0}}};export{e as default};
