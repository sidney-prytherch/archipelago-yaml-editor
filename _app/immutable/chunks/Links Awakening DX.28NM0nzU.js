const e={name:"Player{number}",description:"Default Links Awakening DX Template",game:"Links Awakening DX",requires:{version:"0.4.6"},"Links Awakening DX":{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
...
[Hell] Obscure knowledge and hard techniques may be required. Examples include featherless jumping with boots and/or hookshot, sequential pit buffers and unclipped superjumps. Things in here can be extremely hard to do or very time consuming.`,logic:{normal:50,hard:0,glitched:0,hell:0},"sidneys_secret_documentation-tradequest":`[On] adds the trade items to the pool (the trade locations will always be local items)
...
[Off] The rooster spot is still a check giving an item. But you will never find the rooster. Any rooster spot is accessible without rooster by other means.`,rooster:{false:0,true:50},"sidneys_secret_documentation-experimental_dungeon_shuffle":`[WARNING] Experimental, may fail to fill
...
Note, some entrances can lead into water, use the warp-to-home from the save&quit menu to escape this.`,experimental_entrance_shuffle:{none:50,simple:0},"sidneys_secret_documentation-goal":`The Goal of the game
...
[Open] The Egg will start pre-opened.`,goal:{instruments:50,seashells:0,open:0},"sidneys_secret_documentation-instrument_count":"Sets the number of instruments required to open the Egg",instrument_count:{8:50,sidneys_secret_range_start:0,sidneys_secret_range_end:8,random:0,"random-low":0,"random-high":0},"sidneys_secret_documentation-link_palette":`Sets link's palette
A-D are color palettes usually used during the damage animation and can change based on where you are.`,link_palette:{normal:50,green:0,yellow:0,red:0,blue:0,invert_a:0,invert_b:0,invert_c:0,invert_d:0},"sidneys_secret_documentation-warp_improvements":`[On] Adds remake style warp screen to the game. Choose your warp destination on the map after jumping in a portal and press B to select.
...
[Off] No change`,additional_warp_points:{false:50,true:0},"sidneys_secret_documentation-trendy_game":`[Easy] All of the items hold still for you
[Normal] The vanilla behavior
[Hard] The trade item also moves
[Harder] The items move faster
[Hardest] The items move diagonally
[Impossible] The items move impossibly fast, may scroll on and off the screen`,trendy_game:{easy:0,normal:50,hard:0,harder:0,hardest:0,impossible:0},"sidneys_secret_documentation-gfxmod":`Sets the sprite for link, among other things
...
[Off] (default) doesn't shuffle them.`,text_shuffle:{false:50,true:0},"sidneys_secret_documentation-shuffle_nightmare_keys":`Shuffle Nightmare Keys
...
[Own World] The item will be somewhere in your world
[Any World] The item could be anywhere
[Different World] The item will be somewhere in another world`,shuffle_stone_beaks:{original_dungeon:50,own_dungeons:0,own_world:0,any_world:0,different_world:0},"sidneys_secret_documentation-music":`[Vanilla] Regular Music
[Shuffled] Shuffled Music
[Off] No music`,music:{vanilla:50,shuffled:0,off:0},"sidneys_secret_documentation-shuffle_instruments":`Shuffle Instruments
[Original Dungeon] The item will be within its original dungeon
[Own Dungeons] The item will be within a dungeon in your world
[Own World] The item will be somewhere in your world
[Any World] The item could be anywhere
[Different World] The item will be somewhere in another world
[Vanilla] The item will be in its vanilla location in your world`,shuffle_instruments:{original_dungeon:0,own_dungeons:0,own_world:0,any_world:0,different_world:0,vanilla:50},"sidneys_secret_documentation-music_change_condition":`Controls how the music changes.
[Sword] When you pick up a sword, the music changes
[Always] You always have the post-sword music`,music_change_condition:{sword:0,always:50},"sidneys_secret_documentation-nag_messages":"Controls if nag messages are shown when rocks and crystals are touched. Useful for glitches, annoying for everyone else.",nag_messages:{false:50,true:0},"sidneys_secret_documentation-ap_title_screen":"Enables AP specific title screen and disables the intro cutscene",ap_title_screen:{false:0,true:50},"sidneys_secret_documentation-boots_controls":`Adds additional button to activate Pegasus Boots (does nothing if you haven't picked up your boots!)
...
[Press B] Holding down B activates boots`,boots_controls:{vanilla:50,bracelet:0,press_a:0,press_b:0}}};export{e as default};
