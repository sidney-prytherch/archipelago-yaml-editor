const e={name:"Player{number}",description:"Default DOOM 1993 Template",game:"DOOM 1993",requires:{version:"0.5.0"},"DOOM 1993":{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
...
- **Minimal:** ensure what is needed to reach your goal can be acquired.`,accessibility:{locations:0,items:50,minimal:0},"sidneys_secret_documentation-goal":`Choose the main goal.
...
randomly_flipped: Random levels are flipped`,flip_levels:{vanilla:50,flipped:0,randomly_flipped:0},"sidneys_secret_documentation-allow_death_logic":`Some locations require a timed puzzle that can only be tried once.
...
Turning this setting off is considered easy mode. Good for new players that don't know the levels well.`,reset_level_on_death:{false:0,true:50},"sidneys_secret_documentation-episode1":`Knee-Deep in the Dead.
If none of the episodes are chosen, Episode 1 will be chosen by default.`,episode1:{false:0,true:50},"sidneys_secret_documentation-episode2":`The Shores of Hell.
If none of the episodes are chosen, Episode 1 will be chosen by default.`,episode2:{false:0,true:50},"sidneys_secret_documentation-episode3":`Inferno.
If none of the episodes are chosen, Episode 1 will be chosen by default.`,episode3:{false:0,true:50},"sidneys_secret_documentation-episode4":`Thy Flesh Consumed.
If none of the episodes are chosen, Episode 1 will be chosen by default.`,episode4:{false:50,true:0},"sidneys_secret_documentation-local_items":"Forces these items to be in their native world.",local_items:[],"sidneys_secret_documentation-non_local_items":"Forces these items to be outside their native world.",non_local_items:[],"sidneys_secret_documentation-start_inventory":"Start with these items.",start_inventory:{},"sidneys_secret_documentation-start_hints":"Start with these item's locations prefilled into the ``!hint`` command.",start_hints:[],"sidneys_secret_documentation-start_location_hints":"Start with these locations and their item prefilled into the ``!hint`` command.",start_location_hints:[],"sidneys_secret_documentation-exclude_locations":"Prevent these locations from having an important item.",exclude_locations:[],"sidneys_secret_documentation-priority_locations":"Prevent these locations from having an unimportant item.",priority_locations:[],"sidneys_secret_documentation-item_links":"Share part of your item pool with other players.",item_links:[],"sidneys_secret_documentation-start_inventory_from_pool":`Start with these items and don't place them in the world.
