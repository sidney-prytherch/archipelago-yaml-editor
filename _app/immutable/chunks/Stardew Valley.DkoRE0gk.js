const e={name:"Player{number}",description:"Default Stardew Valley Template",game:"Stardew Valley",requires:{version:"0.5.0"},"Stardew Valley":{"sidneys_secret_documentation-goal":`Goal for this playthrough
...
Perfection: Attain Perfection`,goal:{community_center:50,grandpa_evaluation:0,bottom_of_the_mines:0,cryptic_note:0,master_angler:0,complete_collection:0,full_house:0,greatest_walnut_hunter:0,protector_of_the_valley:0,full_shipment:0,gourmet_chef:0,craft_master:0,legend:0,mystery_of_the_stardrops:0,allsanity:0,perfection:0},"sidneys_secret_documentation-farm_type":"What farm to play on?",farm_type:{standard:0,riverland:0,forest:0,hill_top:0,wilderness:0,four_corners:0,beach:0,random:50},"sidneys_secret_documentation-bundle_randomization":`What items are needed for the community center bundles?
...
Chaos: Same as "Buildings", but the entrances get reshuffled every single day!`,entrance_randomization:{disabled:50,pelican_town:0,non_progression:0,buildings:0,chaos:0},"sidneys_secret_documentation-exclude_ginger_island":`Exclude Ginger Island?
This option will forcefully exclude everything related to Ginger Island from the slot.
If you pick a goal that requires Ginger Island, you cannot exclude it and it will get included anyway`,exclude_ginger_island:{false:50,true:0},"sidneys_secret_documentation-season_randomization":`Should seasons be randomized?
...
Very Cheap: Buildings will cost 1/5th as much`,building_progression:{vanilla:0,vanilla_cheap:0,vanilla_very_cheap:0,progressive:0,progressive_cheap:50,progressive_very_cheap:0},"sidneys_secret_documentation-elevator_progression":`Shuffle the elevator?
...
Progressive from previous floor: Same as progressive, but you cannot use the elevator to check elevator locations.
 You must reach elevator floors on your own.`,elevator_progression:{vanilla:0,progressive:0,progressive_from_previous_floor:50},"sidneys_secret_documentation-festival_locations":`Shuffle Festival Activities?
...
Hard: Festivals have more checks, and many require performing well, not just attending`,festival_locations:{disabled:0,easy:50,hard:0},"sidneys_secret_documentation-arcade_machine_locations":`Shuffle the arcade machines?
...
Start Clear: debris will spawn at the normal rate, but the farm will be completely clear when starting the game`,debris_multiplier:{vanilla:0,half:50,quarter:0,none:0,start_clear:0},"sidneys_secret_documentation-movement_buff_number":`Number of movement speed buffs to the player that exist as items in the pool.
...
- **Minimal:** ensure what is needed to reach your goal can be acquired.`,accessibility:{locations:0,items:50,minimal:0},"sidneys_secret_documentation-gifting":`Do you want to enable gifting items to and from other Archipelago slots?
