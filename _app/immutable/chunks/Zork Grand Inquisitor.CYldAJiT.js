const e={name:"Player{number}",description:"Default Zork Grand Inquisitor Template",game:"Zork Grand Inquisitor",requires:{version:"0.5.0"},"Zork Grand Inquisitor":{"sidneys_secret_documentation-progression_balancing":`A system that can move progression earlier, to try and prevent the player from getting stuck and bored early.
...
- **Minimal:** ensure what is needed to reach your goal can be acquired.`,accessibility:{locations:0,items:50,minimal:0},"sidneys_secret_documentation-goal":`Determines the victory condition

Three Artifacts: Retrieve the three artifacts of magic and place them in the walking castle`,goal:{three_artifacts:50},"sidneys_secret_documentation-quick_port_foozle":"If true, the items needed to go down the well will be found in early locations for a smoother early game",quick_port_foozle:{false:0,true:50},"sidneys_secret_documentation-start_with_hotspot_items":`If true, the player will be given all the hotspot items at the start of the game, effectively removing the need
...
Expect a higher volume of filler items if you enable this option`,start_with_hotspot_items:{false:0,true:50},"sidneys_secret_documentation-deathsanity":"If true, adds 16 player death locations to the world",deathsanity:{false:50,true:0},"sidneys_secret_documentation-grant_missable_location_checks":`If true, performing an irreversible action will grant the locations checks that would have become unobtainable as a
